...
namespace BlobIDS.Config
{
    public class Settings
    {
        ...
        public static void DetectionPeriod_EveryNumberof_Minutes_Set(int newint) { DetectionPeriod_EveryNumberof_Minutes = newint; }
        public static bool EnableFIM { get; private set; } //set the tool to stop monitoring or to start monitoring
        public static void EnableFIM_Set(bool newbool) { EnableFIM = newbool; }
        ...
        //TaskBar Icon, share it so error messages and such can reach it
        public static ProgressBar progressBar1 { get; private set; }
        public static void progressBar1_Set(ProgressBar newbar) { progressBar1 = newbar; }
        ...
        public static bool HealthMonitoring_Enabled { get; private set; } 
        public static void HealthMonitoring_Enabled_Set(bool newbool) { HealthMonitoring_Enabled = newbool; }
    }
