...
namespace BIM_Settings.Alerting
{
    class ErrorLogging
    {
        /// <summary>
        ...
        public static void WriteTo_Log(string title, string description)
        {
            ...
            {
                //CommandLine.ExecuteWorker.Command("/sendemailerror: \"" + title + " - " + description + " \"");
            }
        }
        /// <summary>
        ...
        /// <param name="title"></param>
        /// <param name="description"></param>
        private static void WriteTo_ErrorLog(string title, string description)
        {
            try
            {
